...
class AttendeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendee" do
    assert_difference('Attendee.count') do
      post attendees_url, params: { attendee: { e_mail: @attendee.e_mail, first_name: @attendee.first_name, last_name: @attendee.last_name } }
    end
  ...
  test "should update attendee" do
    patch attendee_url(@attendee), params: { attendee: { e_mail: @attendee.e_mail, first_name: @attendee.first_name, last_name: @attendee.last_name } }
